...
public class LPRotation {
    ...
    public void rightAction(final Component c1,final Component c2, final Component c3,final Component c4,final Component c5, final JLayeredPane l) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                new LPMoveRightTemp().tempPane(c5, l);
            }
        }).start();
    }
}
